...
def eval_video_tracking_davis(
    args, model, scale_factor, frame_list, video_dir, first_seg, seg_ori, color_palette
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--temperature", default=0.1, type=float, help="temperature for softmax"
    )

    parser.add_argument(
        "--output_dir", type=str, help="Path where to save segmentations"
    )
