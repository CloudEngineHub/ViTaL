...
print(LICENSE)
print(
    "Datasets will be downloaded and extracted to ../YouTube, ../YouTube2018, ../static, ../DAVIS, ../long_video_set"
)
...
gdown.download(
    ...
    output="../DAVIS/2017/DAVIS-2017-scribbles-trainval.zip",
    quiet=False,
)
...
with zipfile.ZipFile(
    "../DAVIS/2017/DAVIS-2017-scribbles-trainval.zip", "r"
) as zip_file:
    zip_file.extractall("../DAVIS/2017/")
...
gdown.download(
    "https://drive.google.com/uc?id=100MxAuV0_UL20ca5c-5CNpqQ5QYPDSoz",
    output="../long_video_set/LongTimeVideo.zip",
    quiet=False,
)
